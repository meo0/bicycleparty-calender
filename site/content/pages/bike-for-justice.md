...
私たちは、[自転車は社会変革のためのツール](/pages/mission_statement/)であり、コミュニティを解放し支援できると信じています。Bicycle Party[カレンダー](/calendar/)は、正義を求める中で自転車サポートを組織し宣伝するコミュニティの1つの方法です。自転車は、物資の配達からグループの先導、士気の向上まで、イベントをサポートする重要な役割を果たすことができます！自転車が役立つ方法があれば、[イベントを投稿](/addevent/)して情報を広めてください。
